...
namespace SudoEditor
{
    public partial class Suppression : Form
    {
        ...
        {
            ImageView.Image = SudoEditor.Tilesets[int.Parse(cbNumT.Text)];
            ImageView img = new ImageView();
            ImageView.Image.Tag = $"Tileset {cbNumT.Text}";
            img.Show();
        }
        ...
        {
            ImageView.Image = SudoEditor.Backgrounds[int.Parse(cbNumB.Text)];
            ImageView.Image.Tag = $"Background {cbNumB.Text}";
            ImageView img = new ImageView();
            img.Show();
        }
    }
